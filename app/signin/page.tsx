      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="max-w-md w-full bg-slate-200 dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <button
            ...
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 bg-slate-200 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 px-6 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors font-medium disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {signingIn ? (
